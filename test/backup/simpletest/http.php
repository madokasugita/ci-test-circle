...
class SimpleRoute
{
     ...
     *    @access public
     */
    public function SimpleRoute($url)
    {
        $this->_url = $url;
    }
...
class SimpleProxyRoute extends SimpleRoute
{
     ...
     *    @access public
     */
    public function SimpleProxyRoute($url, $proxy, $username = false, $password = false)
    {
...
class SimpleHttpRequest
{
     ...
     *    @access public
     */
    public function SimpleHttpRequest(&$route, $encoding)
    {
        $this->_route = &$route;
...
class SimpleHttpHeaders
{
     ...
     *    @access public
     */
    public function SimpleHttpHeaders($headers)
    {
...
class SimpleHttpResponse extends SimpleStickyError
{
     ...
     *    @access public
     */
    public function SimpleHttpResponse(&$socket, $url, $encoding)
    {

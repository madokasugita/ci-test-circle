...
class FieldExpectation extends SimpleExpectation
{
     ...
     *    @access public
     */
    public function FieldExpectation($value, $message = '%s')
    {
...
class HttpHeaderExpectation extends SimpleExpectation
{
     ...
     *                            a placeholder for the original message.
     */
    public function HttpHeaderExpectation($header, $value = false, $message = '%s')
    {
        $this->SimpleExpectation($message);
...
class NoHttpHeaderExpectation extends HttpHeaderExpectation
{
     ...
     *                              a placeholder for the original message.
     */
    public function NoHttpHeaderExpectation($unwanted, $message = '%s')
    {
...
class TextExpectation extends SimpleExpectation
{
     ...
     *    @access public
     */
    public function TextExpectation($substring, $message = '%s')
    {
        $this->SimpleExpectation($message);
...
class NoTextExpectation extends TextExpectation
{
     ...
     *    @access public
     */
    public function NoTextExpectation($substring, $message = '%s')
    {
...
class WebTestCase extends SimpleTestCase
{
     ...
     *    @access public
     */
    public function WebTestCase($label = false)
    {

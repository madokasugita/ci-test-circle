var smartGraph = (function(){
	...
	smartGraph.rader = function(args){
		...
		var c1 = polygon_data({radius:radius, center:center, step:step, data:data[0], attr:label_attr[0]});
		var c2 = polygon_data({radius:radius, center:center, step:step, data:data[1], attr:label_attr[1], "marker":1});
...
// 		}
		...
		if(animate){
			...
			c1.animate({transform:"s1", opacity:1}, 200, "-elastic", function(){
				c2.animate({transform:"s1", opacity:1}, 200, "-elastic");
			});

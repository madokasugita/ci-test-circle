...
<div id="scrollmenu" class="button-container"><div class="button-group">
    <input type='button' class='button white' id="totop"value="トップへ"></button><form action="360_message_edit.php?{$SID}" method="post" target="_blank" style="display:inline;margin:0px;"><input type="hidden" name="msgid" value=""><input type="hidden" name="hash" value="{$hash}"><input type="hidden" name="mode" value="edit"><input id="newdata"type="submit" value="新規登録"class="button white"></form>
</div></div>
HTML;
